...
public final class DispatchStrategyConfig<TResult> {
    ...
    public static final class ActionPathDispatchConfig<TResult> {
        ...
        private final List<ActionPathMatchRule<TResult, ?>> rules;

        public ActionPathDispatchConfig(AntPathMatcher matcher, List<ActionPathMatchRule<TResult, ?>> rules) {
        ...
        public List<ActionPathMatchRule<TResult, ?>> getRules() {
            return rules;
        }
    }
}
