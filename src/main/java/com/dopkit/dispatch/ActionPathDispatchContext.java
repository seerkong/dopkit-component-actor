 ...
 */
public final class ActionPathDispatchContext<TRuntime, TRequest, TAction> {
    ...
    public ActionPathDispatchContext(TRuntime runtime, TRequest request, TAction action, String path) {
        this(runtime, request, action, path, null);
    }

    private ActionPathDispatchContext(
            TRuntime runtime,
            TRequest request,
            TAction action,
            String path,
    ...
    public ActionPathDispatchContext<TRuntime, TRequest, TAction> withMatchResult(PathMatchResult result) {
        return new ActionPathDispatchContext<>(runtime, request, action, path, result);
    }
}
